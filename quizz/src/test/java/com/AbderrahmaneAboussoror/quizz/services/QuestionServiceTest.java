...
public class QuestionServiceTest {
    ...
    public void findAllQuestionsTest() {
        ...
        when(questionService.findAll()).thenReturn(questionBeans);
        List<QuestionBean> questionBeanList = questionService.findAll();
        assertEquals(questionBeans.size(), questionBeanList.size());
    }
    @Test
    public void deleteQuestionTest() {
        when(questionService.delete(questionBean.getId())).thenReturn(true);
        boolean questionDeleted = questionService.delete(questionBean.getId());
        assertTrue(questionDeleted);
    }
}
