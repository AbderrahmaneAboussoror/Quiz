...
public class AnswerService implements IAnswerService {
    ...
    public AnswerService(ModelMapper modelMapper, AnswerRepository answerRepository, AssignQuizRepository assignQuizRepository, ValidationRepository validationRepository) {
