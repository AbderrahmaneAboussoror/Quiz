...
public class AssignQuizService implements IAssignQuizService {
    ...
    public AssignQuizService(ModelMapper modelMapper, AssignQuizRepository assignQuizRepository, QuizRepository quizRepository, StudentRepository studentRepository) {
