...
public class QuestionService implements IQuestionService {
    ...
    public QuestionService(ModelMapper modelMapper, QuestionRepository questionRepository, SubjectRepository subjectRepository, LevelRepository levelRepository) {
    ...
    public Page<QuestionBean> findAll(Pageable pageable) {
        ...
        return questionPage.map(question -> modelMapper.map(question, QuestionBean.class));
    }
    @Override
