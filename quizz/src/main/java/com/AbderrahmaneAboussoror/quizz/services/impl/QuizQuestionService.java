...
public class QuizQuestionService implements IQuizQuestionService {
    ...
    public QuizQuestionService(ModelMapper modelMapper, QuizQuestionRepository quizQuestionRepository, QuizRepository quizRepository, QuestionRepository questionRepository) {
